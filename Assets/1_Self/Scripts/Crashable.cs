...
public class Crashable : MonoBehaviour
{
    ...
    void _OnTriggerEnter(Collider other)
    {
        ...
        var blocked = other.GetComponent<Rigidbody>() == null || other.GetComponent<Rigidbody>().velocity.z < CrashBorderVelocity;
        ...
        VibrationController.instance.Play("hit_wall", VibrationController.ControllerSide.Both);
