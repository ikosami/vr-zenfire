...
namespace ToonPeople
{
    public class TP3DController : MonoBehaviour
    {
        ...
        void MoveChar1()
        {
            if (!aim)
            {
                if (grounded)
                {
                    ...
                    rigid.linearVelocity = dirforw * speed * blocked * diverF;
                }                
            }
            else // aiming
            {
                ...
                if (grounded)
                {
                    ...
                    rigid.linearVelocity = dirforw * speed * blocked;
                }                
            }
        }
        void GetInput1()
        ...
        void MoveChar3()
        {
            ...
            if (angleforward < -25f)
            {
                rigid.linearVelocity = dirforw * speed;
        ...
        void CheckGround()
        {
            ...
            if (grounded) rigid.linearDamping = 1;
            else rigid.linearDamping = 0;
        ...
        void Gravity()
        {
            if (!grounded)
            {
                if ((rigid.linearVelocity.y * Vector3.up).magnitude > 3f)
                    grtime += Time.deltaTime;
                rigid.linearVelocity += dirfall * 18f * Time.deltaTime;
            }
            else
            {
                grtime = 0f;
