    ...
    public class RayfireActivator : MonoBehaviour
    {
        ...
        void SetCollider()
        {
            ...
            if (gizmoType == GizmoType.Collider)
            {
                ...
                if (colliders.Length == 0)
                    RayfireMan.Log ("RayFire Activator: " + name + " has no activation collider", gameObject);
        ...
        void SetParticleSystem()
        {
            ...
            if (type != ActivationType.OnCollision)
            {
                ...
                RayfireMan.Log ("Rayfire Activator: " + name + " Particle System Gizmo Type supports only On Collision Activation type. Set Activation Type to On Collision." , gameObject);
            }
        }
        ...
        public void StartAnimation()
        {
            ...
            {
                RayfireMan.Log ("Position list is empty and scale is not animated");
                return;
            }
        ...
        void SetWorldPointsByLine()
        {
            ...
            if (line == null)
            {
                RayfireMan.Log ("Path line is not defined");
                return;
            }
        ...
        public void AddPosition (Vector3 newPos)
        {
            ...
            if (ByLine == true)
            {
                RayfireMan.Log ("Position can be saved only for Global and Local Position animation type.");
                return;
            }
            ...
            {
                RayfireMan.Log ("Activator at the same position.");
                return;
            }
