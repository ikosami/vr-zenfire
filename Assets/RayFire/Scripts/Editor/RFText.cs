...
namespace RayFireEditor
{
    ...
    public static class TextSht
    {
        ...
        const string tlp_slice =  " Hybrid: Meshes with open edges will be cut over thier surface and meshes with closed edges will be sliced to fragments with inner surface. \n" +
        ...
        public static readonly GUIContent gui_adv_hierarchy   = new GUIContent ("Hierarchy",               "");
        ...
        public static readonly GUIContent gui_adv_scl         = new GUIContent ("Inherit Scale",           "Set the same scale to fragments root.");
