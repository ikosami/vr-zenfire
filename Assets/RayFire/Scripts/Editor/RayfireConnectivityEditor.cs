...
namespace RayFireEditor
{
    ...
    public class RayfireConnectivityEditor : Editor
    {
        ...
        void GUI_Preview()
        {
            ...
            GUICommon.Toggle (sp_show_giz, TextCnt.gui_btn_gizmo, GUICommon.color_btn_blue);
            EditorGUILayout.BeginHorizontal();
            GUICommon.Toggle (sp_show_con, TextCnt.gui_btn_cnt,   GUICommon.color_btn_blue);
            GUICommon.Toggle (sp_show_nod, TextCnt.gui_btn_nodes, GUICommon.color_btn_blue);
