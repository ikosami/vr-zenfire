...
namespace RayFireEditor
{
    ...
    public class RayfireUnyieldingEditor : Editor
    {
        ...
        void GUI_Gizmo()
        {
            ...
            GUICommon.Toggle (sp_cent, TextUny.gui_btn_cnt, GUICommon.color_btn_blue);
            if (GUILayout.Button (TextUny.gui_btn_res, GUICommon.buttonStyle, GUILayout.Height (22)))
            {
