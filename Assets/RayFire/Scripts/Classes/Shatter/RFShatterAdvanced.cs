...
{
	/// <summary>
	/// Mesh Export properties class for Rayfire Shatter component.
	/// </summary>
	[Serializable]
	...
	public class RFShatterAdvanced
	{
        ...
        // V2
        public HierarchyType hierarchy = HierarchyType.Instantiate;
        public bool          separate  = true;
        public bool          combine   = true;
        public SliceType     sliceType;
        public bool          inheritScale;
        public int           minFaceFilter;
        public bool          centerSet;
        public Transform     centerBias;
        public bool          aabbEnable   = false;
        public bool          aabbSeparate = false;
        public Transform     aabbObject   = null;
		...
		public RFShatterAdvanced()
		{
			...
			// V2
	        hierarchy     = HierarchyType.Instantiate;
			separate      = true;
	        combine       = true;
