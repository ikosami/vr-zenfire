    ...
    public class RFReferenceDemolition
    {
        ...
        static GameObject GetInstance (RayfireRigid scr, GameObject refGo)
        {
            ...
            if (scr.refDemol.act == ActionType.SetActive)
            {
                ...
                {
                    RayfireMan.Log (RFLimitations.rigidStr + scr.name + " Reference Demolition object is prefab asset. Reference Demolition Action property changed to Instantiate.", scr.gameObject);
