...
public class RASCALInspector : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        PhysicsMaterial physicsMaterial = EditorGUILayout.ObjectField(GetContent("physicsMaterial"), rascal.physicsMaterial, typeof(PhysicsMaterial), true) as PhysicsMaterial;
